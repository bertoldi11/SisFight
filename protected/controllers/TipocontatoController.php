...
class TipocontatoController extends Controller
{
	...
	public function actionNovo()
	{
		...
		{
			$model -> attributes = $_POST['Tipocontato'];
			if ($model -> save())
			{
	...
	{
		$model=(is_null($this->_model)) ? new Tipocontato : $this->_model;	
	...
	{
		$model = Tipocontato::model() -> findByPk($id);
		if ($model === null)
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'tipocontato-form')
		{

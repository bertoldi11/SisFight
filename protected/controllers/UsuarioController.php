...
class UsuarioController extends Controller
{
	...
	public function actionAlterar($id)
	{
		...
		if (isset($_POST['Usuario']))
		{
			//A senha do usuário so pode ser alterada por ele mesmo em função específica	
			if(isset($_POST['Usuario']['senha']))	unset($_POST['Usuario']['senha']);
		...
		$model->dtNasc = Yii::app()->dateFormatter->format("dd/MM/yyyy",strtotime($model->dtNasc));
		$model->senha = '';
		$this->_model = $model;
		$this->actionIndex();
	}

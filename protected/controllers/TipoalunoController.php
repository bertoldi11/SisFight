...
class TipoalunoController extends Controller
{
    ...
    public function actionNovo()
    {
        ...
        {
            $model->attributes=$_POST['Tipoaluno'];
            if ($model -> save())
            {
    ...
    {
        $model=(is_null($this->_model)) ? new Tipoaluno : $this->_model;
        $dataProvider=new CActiveDataProvider('Tipoaluno');
    ...
    {
        $model=Tipoaluno::model()->findByPk($id);
        if($model===null)
    ...
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='tipoaluno-form')
        {

...
/**
 * This is the model class for table "tipoaluno".
 *
 ...
 */
class Tipoaluno extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'alunoturmas' => array(self::HAS_MANY, 'Alunoturma', 'idTipoAluno'),
		);
	}
	 ...
	 * @return Tipoaluno the static model class
	 */

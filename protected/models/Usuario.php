...
class Usuario extends CActiveRecord
{
	...
	private $_chaveEncrypt = 'asd#$12f#$RT76@(wS*';
	...
	protected function beforeSave()
	{
		...
		if($this->isNewRecord)
		{
			...
			$this->dtCadastro = new CDbExpression('NOW()');
		}
	...
	public function rules()
	{
		...
		return array(
			...
			array('senha', 'length', 'max'=>36),
			array('dtNasc, dtCadastro', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idUsuario, nome, email, senha, dtNasc, dtCadastro', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'alunos' => array(self::HAS_MANY, 'Aluno', 'idUsuario'),
			'pagamentos' => array(self::HAS_MANY, 'Pagamento', 'idUsuario'),
		);
	}
